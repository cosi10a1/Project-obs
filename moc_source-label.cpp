...
#include "C:/file obs/obs-studio-master/obs-studio-master/obs/source-label.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OBSSourceLabel_t, stringdata) + ofs \
...
const QMetaObject OBSSourceLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_OBSSourceLabel.data,
      qt_meta_data_OBSSourceLabel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OBSSourceLabel.stringdata))
