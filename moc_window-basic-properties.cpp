...
#include "C:/file obs/obs-studio-master/obs-studio-master/obs/window-basic-properties.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OBSBasicProperties_t, stringdata) + ofs \
...
const QMetaObject OBSBasicProperties::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_OBSBasicProperties.data,
      qt_meta_data_OBSBasicProperties,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OBSBasicProperties.stringdata))
