...
#include "C:/file obs/obs-studio-master/obs-studio-master/obs/window-remux.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OBSRemux_t, stringdata) + ofs \
...
const QMetaObject OBSRemux::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_OBSRemux.data,
      qt_meta_data_OBSRemux,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OBSRemux.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RemuxWorker_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject RemuxWorker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RemuxWorker.data,
      qt_meta_data_RemuxWorker,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RemuxWorker.stringdata))
