...
public:
    ...
    void retranslateUi(QDialog *OBSBasicSourceSelect)
    {
        ...
        createNew->setText(QApplication::translate("OBSBasicSourceSelect", "Basic.SourceSelect.CreateNew", 0));
        selectExisting->setText(QApplication::translate("OBSBasicSourceSelect", "Basic.SourceSelect.AddExisting", 0));
        sourceVisible->setText(QApplication::translate("OBSBasicSourceSelect", "Basic.SourceSelect.AddVisible", 0));
    } // retranslateUi
