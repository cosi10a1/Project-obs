...
public:
    ...
    void setupUi(QDialog *OBSBasicSettings)
    {
        ...
        OBSBasicSettings->resize(896, 667);
        ...
        formLayout_2->setWidget(6, QFormLayout::FieldRole, recordWhenStreaming);
        ...
        formLayout_2->setWidget(8, QFormLayout::SpanningRole, line_4);
        ...
        formLayout_2->setWidget(9, QFormLayout::SpanningRole, groupBox_10);
        ...
        formLayout_2->setWidget(7, QFormLayout::FieldRole, keepRecordStreamStops);
        ...
        simpleOutputPath = new QLineEdit(groupBox_9);
        ...
        simpleOutputBrowse = new QPushButton(groupBox_9);
        ...
        simpleNoSpace = new QCheckBox(groupBox_9);
        ...
        simpleOutRecFormat = new QComboBox(groupBox_9);
        ...
        simpleOutRecFormatLabel = new QLabel(groupBox_9);
        ...
        simpleOutRecQuality = new QComboBox(groupBox_9);
        ...
        simpleOutRecEncoder = new QComboBox(groupBox_9);
        ...
        simpleOutRecEncoderLabel = new QLabel(groupBox_9);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 718, 622));
    ...
    void retranslateUi(QDialog *OBSBasicSettings)
    {
        ...
        groupBox_9->setTitle(QApplication::translate("OBSBasicSettings", "Basic.Settings.Output.Adv.Recording", 0));
