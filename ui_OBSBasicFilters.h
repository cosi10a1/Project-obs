...
public:
    ...
    {
        OBSBasicFilters->setWindowTitle(QApplication::translate("OBSBasicFilters", "Basic.Filters", 0));
        asyncLabel->setText(QApplication::translate("OBSBasicFilters", "Basic.Filters.AsyncFilters", 0));
        addAsyncFilter->setProperty("themeID", QVariant(QApplication::translate("OBSBasicFilters", "addIconSmall", 0)));
        removeAsyncFilter->setProperty("themeID", QVariant(QApplication::translate("OBSBasicFilters", "removeIconSmall", 0)));
        moveAsyncFilterUp->setProperty("themeID", QVariant(QApplication::translate("OBSBasicFilters", "upArrowIconSmall", 0)));
        moveAsyncFilterDown->setProperty("themeID", QVariant(QApplication::translate("OBSBasicFilters", "downArrowIconSmall", 0)));
        label_2->setText(QApplication::translate("OBSBasicFilters", "Basic.Filters.EffectFilters", 0));
        addEffectFilter->setProperty("themeID", QVariant(QApplication::translate("OBSBasicFilters", "addIconSmall", 0)));
        removeEffectFilter->setProperty("themeID", QVariant(QApplication::translate("OBSBasicFilters", "removeIconSmall", 0)));
        moveEffectFilterUp->setProperty("themeID", QVariant(QApplication::translate("OBSBasicFilters", "upArrowIconSmall", 0)));
        moveEffectFilterDown->setProperty("themeID", QVariant(QApplication::translate("OBSBasicFilters", "downArrowIconSmall", 0)));
        close->setText(QApplication::translate("OBSBasicFilters", "Close", 0));
    } // retranslateUi
