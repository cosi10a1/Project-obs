...
#include "C:/file obs/obs-studio-master/obs-studio-master/obs/properties-view.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WidgetInfo_t, stringdata) + ofs \
...
const QMetaObject WidgetInfo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WidgetInfo.data,
      qt_meta_data_WidgetInfo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WidgetInfo.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OBSPropertiesView_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject OBSPropertiesView::staticMetaObject = {
    { &VScrollArea::staticMetaObject, qt_meta_stringdata_OBSPropertiesView.data,
      qt_meta_data_OBSPropertiesView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OBSPropertiesView.stringdata))
