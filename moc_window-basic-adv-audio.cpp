...
#include "C:/file obs/obs-studio-master/obs-studio-master/obs/window-basic-adv-audio.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OBSBasicAdvAudio_t, stringdata) + ofs \
...
void OBSBasicAdvAudio::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        OBSBasicAdvAudio *_t = static_cast<OBSBasicAdvAudio *>(_o);
        switch (_id) {
...
const QMetaObject OBSBasicAdvAudio::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_OBSBasicAdvAudio.data,
      qt_meta_data_OBSBasicAdvAudio,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OBSBasicAdvAudio.stringdata))
        return static_cast<void*>(const_cast< OBSBasicAdvAudio*>(this));
