...
#include "C:/file obs/obs-studio-master/obs-studio-master/obs/focus-list.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FocusList_t, stringdata) + ofs \
...
const QMetaObject FocusList::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_FocusList.data,
      qt_meta_data_FocusList,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FocusList.stringdata))
