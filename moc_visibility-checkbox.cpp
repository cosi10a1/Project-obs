...
#include "C:/file obs/obs-studio-master/obs-studio-master/obs/visibility-checkbox.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VisibilityCheckBox_t, stringdata) + ofs \
...
const QMetaObject VisibilityCheckBox::staticMetaObject = {
    { &QCheckBox::staticMetaObject, qt_meta_stringdata_VisibilityCheckBox.data,
      qt_meta_data_VisibilityCheckBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VisibilityCheckBox.stringdata))
        return static_cast<void*>(const_cast< VisibilityCheckBox*>(this));
