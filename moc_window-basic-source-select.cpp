...
#include "C:/file obs/obs-studio-master/obs-studio-master/obs/window-basic-source-select.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OBSBasicSourceSelect_t, stringdata) + ofs \
...
const QMetaObject OBSBasicSourceSelect::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_OBSBasicSourceSelect.data,
      qt_meta_data_OBSBasicSourceSelect,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OBSBasicSourceSelect.stringdata))
