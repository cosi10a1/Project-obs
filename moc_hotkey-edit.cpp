...
#include "C:/file obs/obs-studio-master/obs-studio-master/obs/hotkey-edit.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OBSHotkeyLabel_t, stringdata) + ofs \
...
const QMetaObject OBSHotkeyLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_OBSHotkeyLabel.data,
      qt_meta_data_OBSHotkeyLabel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OBSHotkeyLabel.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OBSHotkeyEdit_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject OBSHotkeyEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_OBSHotkeyEdit.data,
      qt_meta_data_OBSHotkeyEdit,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OBSHotkeyEdit.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OBSHotkeyWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject OBSHotkeyWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_OBSHotkeyWidget.data,
      qt_meta_data_OBSHotkeyWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OBSHotkeyWidget.stringdata))
