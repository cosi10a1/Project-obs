...
#include "C:/file obs/obs-studio-master/obs-studio-master/obs/window-basic-preview.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OBSBasicPreview_t, stringdata) + ofs \
...
const QMetaObject OBSBasicPreview::staticMetaObject = {
    { &OBSQTDisplay::staticMetaObject, qt_meta_stringdata_OBSBasicPreview.data,
      qt_meta_data_OBSBasicPreview,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OBSBasicPreview.stringdata))
