...
#include "C:/file obs/obs-studio-master/obs-studio-master/obs/window-log-reply.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OBSLogReply_t, stringdata) + ofs \
...
const QMetaObject OBSLogReply::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_OBSLogReply.data,
      qt_meta_data_OBSLogReply,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OBSLogReply.stringdata))
